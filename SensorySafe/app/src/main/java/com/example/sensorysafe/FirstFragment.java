...
public class FirstFragment extends Fragment {
    ...
    // This threshold uses the relative dBFS value reported below, shifted so that
    // 0 dBFS (max) becomes 100 and silence is closer to 0.
    private static final double ALERT_DB_THRESHOLD = 60.0;
            ...
            while (isMeasuring && !Thread.interrupted()) {
                ...
                if (read > 0) {
                    ...
                    if (sum > 0) {
                        ...
                        if (!hasAlertedHighVolume && relativeDb >= ALERT_DB_THRESHOLD) {
